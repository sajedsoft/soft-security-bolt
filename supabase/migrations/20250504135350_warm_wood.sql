...
DROP POLICY IF EXISTS "Controllers can view own data" ON controllers;
DROP POLICY IF EXISTS "PC can manage all data" ON controllers;
DROP POLICY IF EXISTS "Controllers can view own assignments" ON controller_assignments;
DROP POLICY IF EXISTS "PC can manage all assignments" ON controller_assignments;
DROP POLICY IF EXISTS "Controllers can create visits" ON controller_visits;
DROP POLICY IF EXISTS "Controllers can view own visits" ON controller_visits;
DROP POLICY IF EXISTS "PC can manage all visits" ON controller_visits;
DROP POLICY IF EXISTS "Controllers can create evaluations" ON agent_evaluations;
DROP POLICY IF EXISTS "Controllers can view own evaluations" ON agent_evaluations;
DROP POLICY IF EXISTS "PC can manage all evaluations" ON agent_evaluations;
DROP POLICY IF EXISTS "Controllers can create requests" ON explanation_requests;
DROP POLICY IF EXISTS "Controllers can view own requests" ON explanation_requests;
DROP POLICY IF EXISTS "PC can manage all requests" ON explanation_requests;
