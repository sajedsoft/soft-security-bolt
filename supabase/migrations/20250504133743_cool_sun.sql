/*
  ...
  1. New Types
    - evaluation_status for explanation requests
    - evaluation_rating for overall visit ratings

  2. New Tables
    - controllers: Control officers information
    ...
    - explanation_requests: Issue tracking

  3. Security
    - RLS policies for controller and PC roles
...
-- Create controller_visits table
